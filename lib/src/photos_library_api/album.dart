...
@JsonSerializable()
class Album {
  Album(this.id, this.productUrl, this.shareInfo,
  ...
  Album.toCreate(this.title,
      {this.id = '0', this.isWriteable = true, this.mediaItemsCount = '0'});
...
class SharedAlbumOptions {
  SharedAlbumOptions({this.isCollaborative=false, this.isCommentable=false});
